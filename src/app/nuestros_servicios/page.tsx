    ...
    <Section title="Nuestros Servicios" srcImg={ServiciosImg.src} id="nuestros_servicios">
      ...
      <div>
        <p>
          ...
          información financiera necesaria para la apropiada toma de decisiones.
        </p>
        <p>
          Tenemos amplia experiencia en el área de servicios contables, desde su
          registro diario hasta su optimización. Por ello le brindamos los
          medios necesarios para asegurar un mejor procesamiento de sus finanzas
          y un acompañamiento en tu plan de negocios y logro de tus objetivos.
        </p>
        <p>
        ...
        <p>
          Apoyamos a la administración de su empresa con nuestras habilidades
          incluyendo:
        </p>
        <ul className="list-disc">
        ...
        <p>
          ...
          mantenerles informados sobre cambios en la Legislación Fiscal. Conocer
          la información actualizada que permita comprender la legislación
          fiscal es prioritario para que nuestros clientes cumplan con ella a
          conformidad.
        </p>
        ...
        <p>
          ...
          conveniente o más eficiente que sean ejecutados y administrados por un
          tercero a dicha organización.
        </p>
        <p>
          Nuestro equipo está en condiciones de brindarle la mejor solución en
          cualquier materia y optimizar cualquier proceso.
        </p>
        ...
        <ul className="list-disc">
          ...
          <li>Asistencia en elaboración de estados financieros consolidados</li>
          ...
          <li>Legalizaciones de libros que deben llevar los comerciantes</li>
        </ul>
        <p>Nómina</p>
        <p>
          ...
          reportes y pagos; todo a la medida de nuestros clientes, incluyendo:
        </p>
        <ul className="list-disc">
          <li>
